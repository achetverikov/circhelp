...
This is a simple pooled mean + CI summary for illustration. For proper
within-subject inference, use
[`apastats2::get_superb_ci`](https://github.com/achetverikov/apastats) +
[`superb`](https://dcousin3.github.io/superb/) methods.
